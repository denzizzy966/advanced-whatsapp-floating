...
$total_contacts = isset($total_contacts) ? $total_contacts : 0;
$today_contacts = isset($today_contacts) ? $today_contacts : 0;
$this_month_contacts = isset($this_month_contacts) ? $this_month_contacts : 0;
$recent_contacts = isset($recent_contacts) ? $recent_contacts : array();
?>
                        ...
                        <tbody>
                            <?php foreach ($recent_contacts as $contact): ?>
                                <tr>
                                    ...
                                    <td><?php echo esc_html($contact->company ? $contact->company : '—'); ?></td>
...
</div><h2><?php _e('Quick Actions', 'advanced-whatsapp-floating'); ?></h2>
            <div class="awf-action-buttons">
                <a href="<?php echo admin_url('admin.php?page=awf-settings'); ?>" class="button button-primary">
                    <span class="dashicons dashicons-admin-settings"></span>
                    <?php _e('Settings', 'advanced-whatsapp-floating'); ?>
